...
const COLUMN_PATTERNS = {
  name: [
    ...
    'shipping_name', 'billing_name', 'recipient_name', 'ship_to_name', 'buyer_name',
    // Puis les noms génériques
    'full_name', 'customer_name', 'contact_name', 'nom_complet',
    // Et enfin "name" générique en dernier
    'name', 'nom'
  ],
  firstName: [
    'first_name', 'firstname', 'given_name', 'prénom', 'prenom',
    'shipping_first_name', 'billing_first_name'
  ],
  lastName: [
    'last_name', 'lastname', 'family_name', 'surname', 'nom_famille',
    'shipping_last_name', 'billing_last_name'
  ],
  address1: [
    'address', 'address1', 'address_1', 'street', 'street1', 'adresse', 'rue',
    'shipping_address1', 'billing_address1', 'ship_address_1', 'ship_address1',
    'street_address', 'address_line_1'
  ],
  address2: [
    'address2', 'address_2', 'street2', 'adresse2', 'complement_adresse',
    'shipping_address2', 'billing_address2', 'ship_address_2', 'ship_address2',
    'address_line_2'
  ],
  city: [
    'city', 'ville', 'town', 'locality', 'city_name',
    'shipping_city', 'billing_city', 'ship_city'
  ],
  postalCode: [
    'postal_code', 'zip', 'zip_code', 'code_postal', 'postcode', 'zipcode',
    'shipping_zip', 'billing_zip', 'ship_postal_code', 'postal'
  ],
  state: [
    'state', 'province', 'region', 'état', 'etat',
    'shipping_province', 'billing_province', 'ship_state'
  ],
  country: [
    'country', 'pays', 'nation', 'country_name',
    'shipping_country', 'billing_country', 'ship_country'
  ]
}
